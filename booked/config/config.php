...
$conf['settings']['admin.email'] = 'ilariadilucia29@gmail.com';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://localhost:8888/booked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
